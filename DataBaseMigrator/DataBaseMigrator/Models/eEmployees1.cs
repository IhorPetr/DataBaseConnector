namespace DataBaseMigrator.Models
{
    ...
    public partial class eEmployees1
    {
        [DatabaseGenerated(DatabaseGeneratedOption.None)]
        public int eEmployees1Id { get; set; }
        ...
        public int? IdRtStaffHoliday { get; set; }
        ...
        [StringLength(50)]
        public string vcChangeStatus { get; set; }

        public int? PersonId { get; set; }

        [StringLength(50)]
        public string vcContractEnd { get; set; }
    }
}
